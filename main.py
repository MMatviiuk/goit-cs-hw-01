...
class Lexer:
    ...
    def integer(self):
        """Return an integer value collected from a sequence of digits."""
        result = ""
...
class Parser:
    ...
    def factor(self):
        """Parser for numbers and expressions within parentheses."""
        ...
        if token.type == TokenType.INTEGER:
            ...
            node = self.expr()  # process expression inside parentheses
